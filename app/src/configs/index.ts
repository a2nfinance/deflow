...
// export const DELETE_RUN_ENDPOINT = `${MLFLOW_SERVER_API}/2.0/mlflow/runs/delete`
...
export const SERVICES_API_BASE_PATH = process.env.NEXT_PUBLIC_OCEAN_NODE_URI + '/api/services'